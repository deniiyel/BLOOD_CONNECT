...
class AppTheme {
  ...
  static const Color primaryMuted = Color(0xFFC4B5FD);

  // ── Admin accent ─────────────────────────────
  static const Color adminPrimary = primary;
  static const Color adminLight = primaryLight;
  static const Color donorPrimary = Color(0xFFDC2626);
  static const Color donorLight = Color(0xFFFEE2E2);
...
class AppConstants {
  ...
  /// Change this to a secure value stored in your backend, not in source code.
  static const String adminSetupCode = 'BLOODCONNECT-ADMIN';
